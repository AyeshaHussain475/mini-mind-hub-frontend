...
const Islamic = () => {
  return (
    ...
    >
      {/* Section with videos side by side */}
      <div
        style={{
          display: "flex",
      ...
      >
        ...
        <div style={{ flex: "1", padding: "10px", textAlign: "center" }}>
          <video width="100%" height="315" controls>
            <source src="/ab6.mp4" type="video/mp4" />
        ...
        <div style={{ flex: "1", padding: "10px", textAlign: "center" }}>
          <video width="100%" height="315" controls>
            <source src="/ab9.mp4" type="video/mp4" />
            Your browser does not support the video element.
          </video>
        </div>
        ...
        <div style={{ flex: "1", padding: "10px", textAlign: "center" }}>
          <video width="100%" height="315" controls>
            <source src="/ab8.mp4" type="video/mp4" />
            Your browser does not support the video element.
          </video>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ textAlign: "center", width: "40%", padding: "20px" }}>
          ...
          <h4>Arabic</h4>
          <audio controls>
            <source src="/vide26.mp3" type="audio/mp3" />
            Your browser does not support the audio element.
          </audio>
      ...
      <p style={{ textAlign: "center" }}>
        This is some content related to Islam, including teachings, history, and
        more.
      </p>
